   ...
   <nav>
        <div className="flex space-x-14 justify-between items-center">
          ...
          <ul className="flex space-x-5 items-center">
            ...
            <li className="navbar-dropdown text-dark-dark-1 text-base transition-all hover:text-primary-main font-bold" onClick={toggleDropdown} >
          ...
          <div className="flex space-x-5 items-center">
            <a href="#" className="px-3 py-1 log-in border-dark-dark-1 border ">Login</a>
            <a href="#" className="px-3 py-1 log-in border-dark-dark-1 border bg-secondary-main">Join</a>
            <a href="#">
                <img src={bar} alt="" />
            </a>
          </div>
