...
const GrowSave = ({ addClass, isHome, iconClass, secTitle, bgColor }) => {
  const styles = {
  ...
  return (
    <div className={`${bgColor} growandsave section-padding`} style={styles}>
                  ...
                  <div className="grid grid-cols-4 gap-[30px] justify-between align-top">
                    {posts.map((post) => (
                      <a href=""
                        ...
                        <img src={post.img} className={`${isHome ? "m-auto" : iconClass} mb-3 `} alt="icon" />
